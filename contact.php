   ...
   <section class="contact">
      ...
      <div class="row">
         ...
         <form action="" method="post">
            ...
            <textarea name="msg" class="box" required placeholder="Nội dung liên hệ" maxlength="500" cols="30" rows="10"></textarea>
            <input type="submit" value="Gửi thông tin" name="send" class="btn">
         </form>
